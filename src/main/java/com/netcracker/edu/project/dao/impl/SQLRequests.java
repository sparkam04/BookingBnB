...
interface SQLRequests {
    ...
    String SELECT_VALUE_BY_OBJECTID = "SELECT A.VALUE FROM ATTRIBUTES A WHERE A.OBJECT_ID = ? AND A.ATTR_ID IN ( " +
            "  SELECT AT.ATTRTYPE_ID FROM ATTRTYPE AT WHERE AT.OBJECT_TYPE_ID_REF IS NULL )";
