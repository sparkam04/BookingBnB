...
interface SQLRequests {
    ...
    String SELECT_ATTRTYPEID_VALUE_BY_OBJTYPEID = "SELECT ATTRTYPE_ID " +
            "FROM ATTRTYPE WHERE OBJECT_TYPE_ID = ? AND OBJECT_TYPE_ID_REF IS NULL " +
            "ORDER BY ATTRTYPE_ID";
    String SELECT_ATTRTYPEID_SINGLEREF_BY_OBJTYPEID = "SELECT ATTRTYPE_ID " +
            "FROM ATTRTYPE WHERE OBJECT_TYPE_ID = ? AND OBJECT_TYPE_ID_REF IS NOT NULL AND IS_MULTIPLE = 0 " +
            "ORDER BY ATTRTYPE_ID";
    String SELECT_ATTRTYPEID_MULTLEREF_BY_OBJTYPEID = "SELECT ATTRTYPE_ID " +
            "FROM ATTRTYPE WHERE OBJECT_TYPE_ID = ? AND OBJECT_TYPE_ID_REF IS NOT NULL AND IS_MULTIPLE = 1 " +
            "ORDER BY ATTRTYPE_ID";
